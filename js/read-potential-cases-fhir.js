...
(async () => {
  ...
  await fs.writeFile("infection-of-liver-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("infection-of-liver-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
